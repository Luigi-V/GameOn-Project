        ...
        $(document).ready(()=>{
            $.get("DoRetrieveCart",(data,status)=>{
                ...
                if(cart.length>0){
                    ...
                    $("#dateTarg").html("<br>no videogames selected");
